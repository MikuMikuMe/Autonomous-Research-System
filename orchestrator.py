...
def _load_pipeline_config():
    path = os.path.join(SCRIPT_DIR, "configs", "pipeline.yaml")
...
def main():
    ...
    for agent_name in AGENTS:
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            ...
            if agent_name == "auditing":
                try:
                    from format_check_agent import run_format_check, apply_format_fixes
            ...
            if passed:
                ...
                if retry_hint == "revise_claims" and actionable_feedback:
                    ...
                    try:
                        from memory_agent import persist_event
                    ...
                    try:
                        from verification_agent import verify_paper_claims
    ...
    try:
        from memory_agent import persist_session
    ...
    if all_passed:
        ...
        print("  - outputs/paper_draft.md, paper_sections/")
